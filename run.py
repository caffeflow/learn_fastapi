...
# from starlette.exceptions import HTTPException as StarletteHTTPException #等价 from fastapi.exceptions import HTTPException
...
# async def validation_exception_handler(request, exc): # 函数名不是固定的
#     """
#     :param request: 这个参数不能省
#     :param exc:
#     :return:
